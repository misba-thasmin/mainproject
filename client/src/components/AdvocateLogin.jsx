  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
          ...
          //document.cookie = `advocateemail=${encodeURIComponent(email)}; path=/;`;
          //console.log(advocateEmail);  // Output: advocate@gmail.com
        ...
        <div className="background-shape"></div>
             <div className="container">
                ...
                <img className="big-logo" src={imgfolder} alt="" ></img>                
                        ...
                        <div className="login-meta-data"><a className="forgot-password d-block mt-3 mb-1" href="reset_password_advocate">Forgot Password?</a>
                        <p className="mb-0">Didn't have an account?<Link to="/advocate_register" className="ms-1" >Register Now</Link></p>
