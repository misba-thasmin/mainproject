...
import image1 from '../assets/img/balance.png'
import image2 from '../assets/img/compliant.png'
        ...
        <div className="container">
            ...
            <div className="col-6 col-md-12">
              <div className="card horizontal-product-card">
                <div className="card-body d-flex align-items-center">
                  ...
                  <Link  className="text-success" to="/post_advocate">
          ...
          <div className="row g-3">
            <div className="col-6 col-md-12">
              <div className="card horizontal-product-card">
                <div className="card-body d-flex align-items-center">
                  <div className="card-body"><img src={image2} className="img-fluid" style={{width:64, height:64}} />
                  <Link  className="text-success" to="/view_my_advocate">
                   Update Advocate </Link> 
                    </div>
                </div>
              </div>
            </div>
