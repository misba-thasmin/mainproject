...
const AdvocateAuthSwipe = () => {
  const [activeTab, setActiveTab] = useState('login');
  const [email, setEmail] = useState('');
  const [password, setPassword] = useState('');
  const [cookies, setCookie] = useCookies(['advocateemail']);
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (error.response && error.response.status === 401) {
        ...
        setLoginError('Advocate not found');
      } else {
              ...
              <div className="auth-content-container" style={{ position: 'relative', overflow: 'visible', minHeight: '600px' }}>
                ...
                >
                  ...
                  <div className="login-meta-data">
                    <a className="forgot-password d-block mt-3 mb-1" href="reset_password_advocate">
                      Forgot Password?
                    </a>
                  </div>
                </div>
...
export default AdvocateAuthSwipe;
