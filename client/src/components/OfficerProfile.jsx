            ...
            <div className="row" style={{marginTop:10}}>
              ...
              <div className="card product-card" style={{marginBottom:10}}>
                <div className="card-body">
                      ...
                      <a className="product-title d-block"  >Mobile: {officer.mobile}  </a>                      
                      <a className="product-title d-block"  >City: {officer.location}  </a>
                      <a className="product-title d-block"  >City: {officer.department}  </a>
                    </div>
                  </div>   
              </div>
