...
const ResetPasswordAdvocate = () => {
    ...
    /////////////Email Validation //////////////
      ...
      const validateForm = () => {
        ...
        // Validate password
        if (!/(?=.*\d)(?=.*[A-Z])(?=.*[!@#$%^&*()_+])(?=.{8,})/.test(advocateData.newPassword)) {
          errors.password =
    ...
    try {
      const response = await fetch('http://localhost:4000/api/v1/advocate/reset_password', {
        method: 'POST',
        headers: {
        ...
        <div className="background-shape"></div>
             <div className="container">
                ...
                <img className="big-logo" src={imgfolder} alt="" ></img>                
                  ...
                  <input className="form-control" name="email" id="email" value={advocateData.email} onChange={handleChange}  type="email" placeholder="Enter email id"/>
                        </div>
                  ...
                  <input className="form-control" name="question1" id="question1"   value={advocateData.question1} onChange={handleChange} type="text" placeholder="enter the answer"/>
                        </div>
                  ...
                  <input className="form-control" name="question2"id="question2"   value={advocateData.question2} onChange={handleChange} type="text" placeholder="enter the answer"/>
                         </div>
                ...
                <div className="form-group text-start mb-4"><span>Enter New Password</span>
                  ...
                  <input className="input-psswd form-control"   name="newPassword" id="newPassword" value={advocateData.newPassword} onChange={handleChange}  type="password" placeholder="New Password"/>
                </div>
...
export default ResetPasswordAdvocate 