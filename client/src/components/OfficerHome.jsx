...
import "./css/Landing.css"; // Enforces the light theme styles
      ...
      <div className="page-content-wrapper" style={{ minHeight: 'calc(100vh - 140px)', padding: '2rem 0 6rem 0' }}>
        <div className="container" style={{ maxWidth: '900px' }}>
          ...
          <div className="row row-cols-1 row-cols-md-2 g-4 justify-content-center">
            ...
            {/* View Complaints */}
            <div className="col">
              <Link to="/view_complaint_officer" style={{ textDecoration: 'none' }}>
                <div className="card h-100 shadow-sm border-0 portal-card" style={{ backgroundColor: '#ffffff', borderRadius: '20px', transition: 'all 0.3s ease' }}>
                  <div className="card-body p-4 d-flex align-items-center">
                    <div className="icon-wrapper bg-primary bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center me-4" style={{ width: '60px', height: '60px', minWidth: '60px' }}>
                      <i className="fa fa-folder-open text-primary" style={{ fontSize: '24px' }}></i>
                    </div>
                    <div>
                      <h5 className="card-title fw-bold text-dark mb-1">View Complaints</h5>
                      <p className="card-text text-muted small mb-0">Browse and manage active incident complaints</p>
                    </div>
                  </div>
                </div>
              </Link>
            ...
            {/* Total Reports */}
            <div className="col">
              <Link to="/view_complaint_report_officer" style={{ textDecoration: 'none' }}>
                <div className="card h-100 shadow-sm border-0 portal-card" style={{ backgroundColor: '#ffffff', borderRadius: '20px', transition: 'all 0.3s ease' }}>
                  <div className="card-body p-4 d-flex align-items-center">
                    <div className="icon-wrapper bg-success bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center me-4" style={{ width: '60px', height: '60px', minWidth: '60px' }}>
                      <i className="fa fa-chart-bar text-success" style={{ fontSize: '24px' }}></i>
                    </div>
                    <div>
                      <h5 className="card-title fw-bold text-dark mb-1">Total Reports</h5>
                      <p className="card-text text-muted small mb-0">Access detailed generated metric reports</p>
                    </div>
                  </div>
                </div>
              </Link>
                ...
                <div className="card h-100 shadow-sm border-0 portal-card" style={{ backgroundColor: '#ffffff', borderRadius: '20px', transition: 'all 0.3s ease' }}>
                  <div className="card-body p-4 d-flex align-items-center">
                    <div className="icon-wrapper bg-warning bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center me-4" style={{ width: '60px', height: '60px', minWidth: '60px' }}>
                      <i className="fa fa-users text-warning" style={{ fontSize: '24px' }}></i>
                    </div>
                    <div>
                      <h5 className="card-title fw-bold text-dark mb-1">View User Profile</h5>
                      <p className="card-text text-muted small mb-0">Review registered citizen accounts system data</p>
                    </div>
                  </div>
                </div>
              </Link>
            ...
            {/* View My Feedback */}
            <div className="col">
              <Link to="/my_feedback" style={{ textDecoration: 'none' }}>
                <div className="card h-100 shadow-sm border-0 portal-card" style={{ backgroundColor: '#ffffff', borderRadius: '20px', transition: 'all 0.3s ease' }}>
                  <div className="card-body p-4 d-flex align-items-center">
                    <div className="icon-wrapper rounded-circle d-flex align-items-center justify-content-center me-4" style={{ width: '60px', height: '60px', minWidth: '60px', backgroundColor: '#f3e8ff' }}>
                      <i className="fa fa-comments" style={{ fontSize: '24px', color: '#a855f7' }}></i>
                    </div>
                    <div>
                      <h5 className="card-title fw-bold text-dark mb-1">View My Feedback</h5>
                      <p className="card-text text-muted small mb-0">Read feedback directed to this officer account</p>
                    </div>
                  </div>
                </div>
              </Link>
            ...
            {/* My Profile */}
            <div className="col">
              <Link to="/officer_profile" style={{ textDecoration: 'none' }}>
                <div className="card h-100 shadow-sm border-0 portal-card" style={{ backgroundColor: '#ffffff', borderRadius: '20px', transition: 'all 0.3s ease' }}>
                  <div className="card-body p-4 d-flex align-items-center">
                    <div className="icon-wrapper bg-secondary bg-opacity-10 rounded-circle d-flex align-items-center justify-content-center me-4" style={{ width: '60px', height: '60px', minWidth: '60px' }}>
                      <i className="fa fa-user-circle text-secondary" style={{ fontSize: '24px' }}></i>
                    </div>
                    <div>
                      <h5 className="card-title fw-bold text-dark mb-1">My Profile</h5>
                      <p className="card-text text-muted small mb-0">Manage officer account details and security</p>
                    </div>
                  </div>
                </div>
              </Link>
