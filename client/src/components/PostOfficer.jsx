...
// name  Officername mechanicname service available  locality address city mobile 
...
const PostOfficer = () => {
  ...
  const postOfficerData = async () => {
    ...
    //console.log(adminEmail);  // Output: Officer@gmail.com
    ...
    try {
      ...
      if (response.ok) {
        console.log('Officer data posted successfully!');
        // Handle success, e.g., redirect to another page
        alert('Officer id Created Successful');
        window.location.href = "/admin_home";

      } else {
        console.error('Error posting Officer data:', response.statusText);
      }
    } catch (error) {
      ...
      <div className="top-products-area py-3">
        <div className="container">
          <div className="section-heading d-flex align-items-center justify-content-between">
            <h4><strong>Officer Register</strong></h4>
          </div>
        {/* Form Scrip Start*/}
