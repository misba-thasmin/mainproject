...
const ViewAdvocate = () => {
  ...
  ////////////////////////////////////////////////  
  // Set Vendor email
  const [advocateemail, setShareLocation] = useState(''); // Set the initial value accordingly
  ...
  const shareLocation = () => {
    // Assuming business.advocateemail contains the vendor's email
    // Store advocateemail in cookies
    document.cookie = `advocateemail=${advocateemail}`;
  ...
  ////////////////////////////////////////////////  
  // Set Vendor email
  const [advocate_email, Feedbackfunction] = useState(''); // Set the initial value accordingly
  // Trigger getUserLocation when businessId changes
  useEffect(() => {
    if (advocate_email) {
      updateFeedback();
  ...
  const updateFeedback = () => {
    // Assuming business.advocateemail contains the advocate's email
    // Store advocateemail in cookies
    document.cookie = `advocateemail=${advocate_email}`;
    // For example, redirect to another page
      ...
      <div className="top-products-area py-3">
        ...
        <div className="section-heading d-flex align-items-center justify-content-between">
          ...
          <div className="row g-3" >
            ...
            {/* <a className="btn btn-danger"  onClick={() => setShareLocation(business.advocateemail)}  >Request</a> */}
